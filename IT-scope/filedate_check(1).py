...
Subject: IT-Scope Pricelist Data/source Error!

One of the files for IT-Scope Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    if artzub and artikel and stocklist == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_IT-Scope\\Preisliste IT Scope Reporting PQ - Copy.xlsm')
