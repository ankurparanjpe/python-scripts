...
SUBJECT = f"Brodos Preisliste {today}"
EMAIL_TO = ['info@zisaline.de','Besar.Limani@brodos.de','rncteam@brodos.net']
...
try:
    ...
    part.set_payload(open(f"I:/Abteilungen/Reporting_und_Controlling/private/Preislisten/t_Zisaline/testingxlsx/Zisaline_Preisliste_{today1}.xlsx", "rb").read(),'UTF-8')
    encoders.encode_base64(part)
    part.add_header('Content-Disposition', f'attachment; filename="Zisaline_Preisliste_{today1}.xlsx"')
    msg.attach(part)
