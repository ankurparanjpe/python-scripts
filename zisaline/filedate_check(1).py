...
Subject: t_Zisaline Pricelist Data/source Error!

One of the files for t_Zisaline Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    if produkte and artzub and artikel and lagreich == today1:
        xl = Dispatch("Excel.Application")
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_Zisaline\\Zisaline REPORTING - Copy.xlsm')
        print('yes available')
    else:
        print('nope')
