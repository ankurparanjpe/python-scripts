...
Subject: t_HDK Pricelist Data/source Error!

One of the files for t_HDK Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    if artikel == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_HDK\\HDK_REPORTING - Copy.xlsm')
