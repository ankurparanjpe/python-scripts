...
Subject: t_cyberport Pricelist Data/source Error!

One of the files for t_cyberport Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    if artzub and artikel and stocklist == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_cyberport\\PRL REPORTING - Copy.xlsm')
