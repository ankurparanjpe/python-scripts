...
Subject: t_Duttenhofer File Data/source Error!

One of the files for t_Duttenhofer report file source are older or not available in required path!
"""
...
try:
    ...
    if artzub and artikel and stocklist == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_Duttenhofer\\PRL REPORTING - Copy.xlsm')
