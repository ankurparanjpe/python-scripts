...
Subject: t_belsimpel File Data/source Error!

One of the files for t_belsimpel report file source are older or not available in required path!
"""
...
try:
    ...
    if artzub and artikel and stocklist ==today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_belsimpel\\PRL REPORTING - Copy.xlsm')
