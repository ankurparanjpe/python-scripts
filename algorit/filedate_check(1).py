...
Subject: t_Algorit Pricelist Data/source Error!

One of the files for t_Algorit Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    if artzub and artikel and stocklist == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_Algorit\\Algorit PRL REPORTING - Copy.xlsm')
