...
SUBJECT = "Preisliste Bestcom Success"
#EMAIL_TO = ['Johanna.Neumann@brodos.de']
EMAIL_TO = ['rncteam@brodos.net']


message_failed = """From: <rncteam@brodos.net>
Subject: Bestcom Pricelist Error!

Bestcom Pricelist didnt found on the required path or not refreshed successfully. Please check manually!
"""

try:
    copyfile(f'I:/Abteilungen/Reporting_und_Controlling/private/Preislisten/t_Bestcom/testingcsvs/BC_{today}_1.csv', f'I:/daten/bnet-imp/NORMAL_PRICEIMPORT/BC_{today}_1.csv')
    copyfile(f'I:/Abteilungen/Reporting_und_Controlling/private/Preislisten/t_Bestcom/testingcsvs/BC_{today}_2.csv', f'I:/daten/bnet-imp/NORMAL_PRICEIMPORT/BC_{today}_2.csv')
    msg = MIMEMultipart()
    msg['Subject'] = SUBJECT 
    ...
    #msg.attach(part)
    body = f"Hallo,\n\nBestcom files are copied to 'NORMAL_PRICEIMPORT' folder."
