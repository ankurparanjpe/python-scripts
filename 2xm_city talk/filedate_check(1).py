...
email_send = ['ankur.paranjpe@brodos.net','rncteam@brodos.net']
message_file = """From: <rncteam@brodos.net>
Subject: City Talk Pricelist Data/source Error!

One of the files for City Talk Pricelist file source are older or not available in required path!
"""

try:
    pricelist = os.path.isfile('I:/Abteilungen/Reporting_und_Controlling/Data/allgemein/Price Lists/Data/Preislisten mapping.xlsx')
    ...
    if produkte and artzub and artikel and stocklist == today1:
        xl = Dispatch("Excel.Application")
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\2xm_City Talk\\City Talk REPORTING - Copy.xlsm')
        print('yes available')
    else:
        print('nope')
