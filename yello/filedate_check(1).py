...
Subject: Yello Pricelist Data/source Error!

One of the files for Yello Pricelist file source are older or not available in required path!
"""
...
try:
    ...
    yello_offer = os.path.isfile(f'I:/Abteilungen/Konzern-und-Geschaeftskunden/public/yello/Schnittstelle/Yello_Product_Offer_Mapping/Yello_Product_Offer_Mapping.xlsx')
    artikel_list = os.path.isfile(f'I:/Abteilungen/Konzern-und-Geschaeftskunden/public/yello/Schnittstelle/Artikelliste für Bestandsübermittlung.xlsx')
    ...
    if artzub and artikel and stocklist == today1:
        ...
        xl.Visible = True
        wb = xl.Workbooks.Open(r'I:\\Abteilungen\\Reporting_und_Controlling\\private\\Preislisten\\t_Yello\\PRL REPORTING - Copy.xlsm')
