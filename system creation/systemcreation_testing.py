...
try:
    if i < 11:
        ...
        driver.find_element_by_xpath('//*[@id="name1"]').send_keys(str(customer[i]))
        ...
        driver.find_element_by_xpath('//*[@id="ext-comp-1322"]').send_keys(str(customer[i])+"\n")
        ...
        time.sleep(3)
        driver.find_element_by_xpath('//*[@id="ext-gen15"]').click()
        driver.find_element_by_xpath('//*[text()="Customers"]').click()
        time.sleep(1)
        driver.find_element_by_xpath('//*[@id="ext-comp-1085"]').click()
        time.sleep(1)
        driver.find_element_by_xpath('//*[text()="Default settings"]').click()
        time.sleep(1)
