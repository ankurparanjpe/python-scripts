...
EMAIL_TO = ['office@o-connect.com','admin@o-connect.com','bvasileva@o-connect.com','marc.goergens@brodos.de','rncteam@brodos.net']
...
Subject: Oconnect Pricelist Error!

Oconnect Pricelist didnt found on the required path or not refreshed successfully. Please check manually!
"""
...
try:
    ...
    part.set_payload(open("I:/Abteilungen/Reporting_und_Controlling/private/Preislisten/t_Oconnect/xlsxcopies/PRL Oconnect.xlsx", "rb").read(),'UTF-8')
    encoders.encode_base64(part)
    part.add_header('Content-Disposition', 'attachment; filename="PRL Oconnect.xlsx"')
    msg.attach(part)
